...
Task arrives
    ...
    │   └── Running in a Flutter app? ─→ flutter-devtools-and-device-testing
...
| Build | flutter-ui-engineering | Production-quality Flutter UI with accessibility |
| Build | api-and-interface-design | Stable interfaces with clear contracts |
| Verify | test-driven-development | Failing test first, then make it pass |
| Verify | flutter-devtools-and-device-testing | Flutter DevTools, Dart MCP, and mobile-mcp for runtime verification |
